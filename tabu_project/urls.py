...
urlpatterns = [
    ...
    path('', views.welcome_view, name="welcome"),  # Root URL artık welcome_view'a yönlendiriyor.
    ...
    #path('waiting_room/<int:lobby_id>/', views.waiting_room, name='waiting_room'),
    ...
    #path('new_explainer/<int:lobby_id>/', views.new_explainer, name='new_explainer'),
]
